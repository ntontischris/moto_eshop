...
This project is indexed by GitNexus as **moto_eshop** (4438 symbols, 7320 relationships, 210 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/moto_eshop/context` | Codebase overview, check index freshness |
| `gitnexus://repo/moto_eshop/clusters` | All functional areas |
| `gitnexus://repo/moto_eshop/processes` | All execution flows |
| `gitnexus://repo/moto_eshop/process/{name}` | Step-by-step execution trace |
