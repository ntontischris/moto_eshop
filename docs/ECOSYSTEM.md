# Motomarket — AI & Growth Ecosystem

Ζωντανό backlog για το «οικοσύστημα» γύρω από το e-shop: AI/automation,
growth, retention, CRM. **Καθώς τσεκάρουμε σιγά-σιγά το site, εδώ μαζεύουμε
τις ιδέες** — πρώτα η σκέψη, μετά ο σχεδιασμός, μετά η υλοποίηση.

> Σχέση με τα υπόλοιπα: το `ROADMAP.md` = το storefront (σελίδες/features).
> Το `project-home-engagement-roadmap` (memory) = τα home engagement modules.
> Αυτό το αρχείο = τα **AI + growth** κομμάτια που πατάνε πάνω στο μελλοντικό
> Odoo/AI management. Backend στόχος: Odoo 18 (βλ. memory `feedback-odoo-backend`).

Κατάσταση: 🔵 ιδέα · 🟡 σχεδιασμένο · 🟢 σε υλοποίηση · ✅ live

---

## Feature #1 — 🔵 AI Review Engine
...
- Discount-code generator + redemption tracking (δένει με checkout).
- Brand-voice config.
...
_(Θα προστίθενται καθώς τσεκάρουμε το site.)_
