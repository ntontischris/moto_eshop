...
export default function CheckoutClient({
  ...
  async function submit(e: React.FormEvent) {
    ...
    // Card: leave the cart intact (a cancel must return it untouched) and hand
    // off to the provider-hosted page. The webhook — not this redirect —
    // creates the order; the cart is cleared on the confirmed success page.
      ...
      <form className="v3-co-grid" onSubmit={submit}>
        <div className="v3-co-form">
          ...
          <section className="v3-co-block">
            ...
            {canceled && <p className="v3-co-err">{t("payCanceled")}</p>}
            <div className="v3-co-pay">
              <label
                className={`v3-co-pay-opt ${pay === "cod" ? "is-on" : ""}`}
              >
                <input
                  type="radio"
                  name="pay"
              ...
              <label
                className={`v3-co-pay-opt ${
                  !cardEnabled ? "is-off" : pay === "card" ? "is-on" : ""
                }`}
              >
                <input
                  type="radio"
                ...
                />
                <span>
                  {cardEnabled ? t("cardLabelActive") : t("cardLabel")}
                </span>
              </label>
            </div>
          </section>
