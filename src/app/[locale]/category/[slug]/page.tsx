...
import { categoryRedirectTarget } from "@/app/[locale]/(store)/category/[slug]/redirect-target";
...
// request time inside the Suspense boundary; the prefixed URL serves no category
