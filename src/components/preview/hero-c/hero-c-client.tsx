...
import { HERO_C_RANGES, type HeroCBeat } from "./beats";
import { HeroCPanels } from "./panels";
import {
  useIsMobile,
  useReducedMotion,
  useScrollProgress,
...
// Lazy-load the WebGL scene so it stays out of the initial bundle parse path
// and never executes in environments without window.
const HeroCScene = dynamic(
  () => import("./scene").then((m) => ({ default: m.HeroCScene })),
  { ssr: false },
);
