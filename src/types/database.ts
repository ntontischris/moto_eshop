    ...
    Tables: {
      ...
      product_stock_locations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_stock_locations_warehouse_code_fkey";
      ...
      products: {
        Row: {
          ...
          description: string | null;
          ean: string | null;
          erp_has_missing_fields: boolean;
          erp_id: string | null;
          id: string;
          images: Json;
          images_cdn: Json | null;
          is_featured: boolean;
